...
(function () {
  ...
  function loadArticles() {
    window.DashboardUI.authFetch('/api/v1/knowledge-posts')
      ...
      .catch(function () {
        window.DashboardUI.toast('ဆောင်းပါးစာရင်း တင်ရန် မအောင်မြင်ပါ။', 'Failed to load articles.', 'bi-exclamation-triangle-fill');
      });
  }
