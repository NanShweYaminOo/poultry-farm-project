...
(function () {
  ...
  function loadBreeds() {
    window.DashboardUI.authFetch('/api/v1/breeds')
      ...
      .catch(function () {
        window.DashboardUI.toast('မျိုးရင်းစာရင်း တင်ရန် မအောင်မြင်ပါ။', 'Failed to load breeds.', 'bi-exclamation-triangle-fill');
      });
  }
