...
(function () {
  ...
  function loadTickets() {
    window.GuestUI.authFetch('/api/v1/feedback-tickets')
      ...
      .catch(function () {
        window.GuestUI.toast('တင်ပြချက်များ တင်ရန် မအောင်မြင်ပါ။', 'Failed to load your tickets.', 'bi-exclamation-triangle-fill');
      });
  }
  ...
  function submitFeedback() {
    ...
    if (!content) {
      window.GuestUI.toast('အကြောင်းအရာ ဖြည့်စွက်ပါ။', 'Content is required.', 'bi-exclamation-triangle-fill');
      return;
    }
    ...
    window.GuestUI.authFetch('/api/v1/feedback-tickets', {
      ...
      .then(function (response) {
        ...
        contentInput.value = '';
        loadTickets();
        window.GuestUI.toast('အကြံပြုချက် တင်ပြပြီးပါပြီ။', 'Feedback submitted.');
      })
      .catch(function () {
        window.GuestUI.toast('အကြံပြုချက် တင်ပြ၍ မရပါ။', 'Could not submit feedback.', 'bi-exclamation-triangle-fill');
      })
      .finally(function () {
