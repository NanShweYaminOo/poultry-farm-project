...
<c:set var="pageTitle" value="ကျွန်ုပ်၏ပရိုဖိုင် | Broiler Admin" />
...
<c:set var="topbarSubMy" value="သင့်အက်ဒမင်အကောင့် အချက်အလက်များနှင့် စကားဝှက်ကို စီမံခန့်ခွဲရန်" />
<c:set var="topbarSubEn" value="Manage your admin account details and password" />
<!DOCTYPE html>
      ...
      <div class="row g-3">
        <div class="col-lg-4">
          <div class="card text-center" style="padding:30px 22px;">
            <div id="profileAvatar" class="mx-auto mb-3" style="width:96px;height:96px;border-radius:50%;background:linear-gradient(135deg,var(--emerald-600),var(--emerald-900));color:var(--gold-300,var(--gold-400));display:flex;align-items:center;justify-content:center;font-size:34px;font-weight:700;border:3px solid var(--gold-500);overflow:hidden;">SA</div>
            <h3 id="profileFullName" class="h5 mb-0">Super Admin</h3>
            <p id="profileEmail" style="font-size:12.5px;color:var(--muted);" class="mb-3">admin@broiler.local</p>
            <span id="profileRole" class="badge badge-gold mx-auto" style="width:fit-content;">ADMIN</span>
            ...
            <form id="profileForm">
              <div class="row g-3">
                <div class="col-md-6">
                  ...
                  <input type="text" class="form-control" id="fullNameInput" value="Super Admin">
                </div>
                <div class="col-md-6">
                  <label class="form-label i18n" data-my="အသုံးပြုသူအမည်" data-en="Username">အသုံးပြုသူအမည်</label>
                  <input type="text" class="form-control" id="usernameInput" value="admin" readonly>
                </div>
                <div class="col-md-6">
                  <label class="form-label i18n" data-my="အီးမေးလ်" data-en="Email">အီးမေးလ်</label>
                  <input type="email" class="form-control" id="emailInput" value="admin@broiler.local" readonly>
                </div>
                <div class="col-md-6">
                  <label class="form-label i18n" data-my="ဖုန်းနံပါတ်" data-en="Phone Number">ဖုန်းနံပါတ်</label>
                  <input type="text" class="form-control" id="phoneInput" value="+95 9 123 456 789">
                </div>
              </div>
...
<script src="<c:url value='/admin/assets/js/profile-page.js'/>"></script>
</body>
</html>
