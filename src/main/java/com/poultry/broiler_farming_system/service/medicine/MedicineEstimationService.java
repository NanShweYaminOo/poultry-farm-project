...
public interface MedicineEstimationService {
     ...
     */
    MedicineEstimateResponse estimate(MedicineEstimateRequest request);
     ...
     */
    MedicineEstimateResponse estimateForAlarm(Long batchAlarmId, BigDecimal userPricePerUnit);
     ...
     * batch_expenses ledger entry.
     */
    MedicineTaskCompletionResponse completeTask(MedicineTaskCompletionRequest request);
}
